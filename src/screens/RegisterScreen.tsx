    ...
    <SafeAreaView className="bg-white flex-1 p-6 flex flex-col justify-between h-full">
      <View className="flex-1 flex flex-col items-center justify-center my-4 w-full">
        ...
        <TouchableOpacity 
          ...
          className="w-full py-3 border border-slate-200 rounded-full flex flex-row items-center justify-center gap-2.5 text-sm bg-white hover:bg-slate-50 shadow-2xs"
        >
          ...
          <Text className="font-sans font-bold text-slate-700 text-sm">Continue with Google</Text>
        </TouchableOpacity>
