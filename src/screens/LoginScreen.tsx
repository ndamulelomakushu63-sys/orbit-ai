  ...
  return (
    <SafeAreaView className="bg-white flex-1 p-6 flex flex-col justify-between h-full">
      <View className="flex-1 flex flex-col items-center justify-center my-4 w-full">
        ...
        <TouchableOpacity 
          disabled
          className="w-full mt-6 py-3 border border-slate-200 rounded-full flex flex-row items-center justify-center gap-2.5 text-sm bg-white opacity-50 cursor-not-allowed shadow-2xs"
        >
          ...
          <Text className="text-slate-400 font-semibold text-sm">Coming soon</Text>
        </TouchableOpacity>
